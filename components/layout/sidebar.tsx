...
const navigation = [
  ...
  { id: "harbor", name: "Harbor Registry", icon: Package, badge: "3" },
  { id: "workflow", name: "Workflow", icon: GitBranch, badge: "5" }, // Added workflow tab
  ...
  { id: "contacts", name: "Contacts", icon: Building2, badge: null },
  ...
  { id: "audit", name: "Audit", icon: FileText, badge: null },
