...
export function ContainerEnvironmentDashboard() {
  const [environments, setEnvironments] = useState<ContainerEnvironment[]>(mockEnvironments)
  const [stacks, setStacks] = useState<ContainerStack[]>(mockStacks)
  const [events, setEvents] = useState<ContainerEvent[]>(mockEvents)
